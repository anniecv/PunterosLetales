...
class ErrorHandler:
    ...
    def dibujar(self, ventana, estado_juego):
        if self.mostrar_mensaje:
            ...
            s = pygame.Surface((ANCHO, 60), pygame.SRCALPHA)
            s.fill((50, 50, 50, 200))
            ventana.blit(s, (0, ALTO // 2 - 30))
        ...
        if estado_juego.jaque and not estado_juego.finalizado:
            ...
            pygame.draw.rect(ventana, (255, 255, 200), (ANCHO - texto.get_width() - 20, 10, 
                                                        texto.get_width() + 10, texto.get_height() + 10))
            pygame.draw.rect(ventana, (220, 0, 0), (ANCHO - texto.get_width() - 20, 10, 
                                                    texto.get_width() + 10, texto.get_height() + 10), 3)
            
            ventana.blit(texto, (ANCHO - texto.get_width() - 15, 15))
            ...
            ventana.blit(texto_info, (ANCHO - texto_info.get_width() - 15, 55))
    ...
    def mostrar_fin_juego(self, ventana, mensaje):
        ...
        pygame.draw.rect(ventana, FONDO_MENSAJE, (ANCHO//2-200, ALTO//2-50, 400, 100))
        pygame.draw.rect(ventana, BORDE_MENSAJE, (ANCHO//2-200, ALTO//2-50, 400, 100), 3)
        ...
        ventana.blit(texto_inst, (ANCHO//2 - texto_inst.get_width()//2, ALTO//2 + 40))  # CORRECCIÓN: Quitado paréntesis extra