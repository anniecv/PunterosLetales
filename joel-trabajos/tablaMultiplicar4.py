...
assert verificar_adivinanza(50, 25) == "Demasiado bajo", "Error: se esperaba 'Demasiado bajo'"
assert verificar_adivinanza(50, 75) == "Demasiado alto", "Error: se esperaba 'Demasiado alto'"
assert verificar_adivinanza(50, 50) == "Correcto", "Error: se esperaba 'Correcto'"
